...
if __name__ == "__main__":
    ...
    parser.add_argument("--tosavefilename", help = "")
    args = parser.parse_args()

    preprocess_for_training(args.filename,regression = args.regression,R_clustering = args.R_clustering,issignal = args.issignal, tosavefilename = args.tosavefilename)
