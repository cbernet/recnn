...
if __name__ == "__main__":
    ...
    parser.add_argument("filename", help = "Name of the file to convert.",type = str)
    parser.add_argument("--regression", help = "Add this to use regression data.", action = "store_true")
    parser.add_argument("--R_clustering", help = "0.3 for subjet, 0. for particle", type = float, default = 0.3)
    parser.add_argument("--issignal", help = "Add this if you are converting the signal sample of your discrimination set.", action = "store_true")
    ...
    if args.R_clustering == 0.:
        ...
        preprocess_for_training(args.filename,regression = args.regression,R_clustering = args.R_clustering,issignal = args.issignal)
